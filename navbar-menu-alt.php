...
<div class="collapse navbar-collapse" id="navbarColor02">
  <ul class="navbar-nav mr-auto">
    ...
    <div class="dropup bg-dark">
      <a class="nav-link _dropdown-toggle text-success" href="icerik-ekle.php" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onmouseenter="$('#_icerik-dropdown-ust').show();">Araç...</a>
      <div id="icerik-dropdown-ust" class="dropdown-menu bg-dark text-light" aria-labelledby="dropdownMenuButton"  onmouseleave="$('_#icerik-dropdown-ust').hide();">
        <?php include('kalip/arac-menu.php'); ?>
      </div>
    </div>     
    </li>
  </ul>
